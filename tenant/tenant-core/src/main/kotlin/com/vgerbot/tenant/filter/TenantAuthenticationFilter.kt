package com.vgerbot.com.vgerbot.tenant.filter

import com.vgerbot.tenant.com.vgerbot.tenant.context.TenantContext
...
class TenantAuthenticationFilter : OncePerRequestFilter() {
     ...
     * 2. 否则使用用户的默认租户
     */
    private fun getTenantForUser(userId: Int, request: HttpServletRequest): TenantInfo? {
        // 1. 尝试从请求头获取租户 ID
