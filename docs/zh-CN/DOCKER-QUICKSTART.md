...
| MariaDB | 3306 | 应用数据库 |
| Logto App | 3001, 3002 | 认证服务 |
| PostgreSQL | 5432 | Logto 数据库 |

## 💡 设计理念

### 为什么使用两个 docker compose 文件？

✅ **模块化管理**: Logto 是独立的认证服务，单独维护更清晰  
✅ **灵活部署**: 可以选择只启动需要的服务  
✅ **易于维护**: logto/docker-compose.yml 保持原样，便于更新  
